...
public class TC_13 extends BaseClass {
	...
	public void TC_13Test() throws FileNotFoundException, IOException
	{
		...
		newOppo.creatingOpportunity_salesstage(driver, AutoConstants.creatingOpportunity,Readprop.getData_salesstage("option1") );
...
//		
//		CreatingNewOpportunityPage newOppo = new CreatingNewOpportunityPage(driver);
//		newOppo.creatingOpportunity_salesstage(driver, AutoConstants.creatingOpportunity);
//		
//		
//		OpportunityInfoPage OppoInfo = new OpportunityInfoPage(driver);
//		OppoInfo.verify();
